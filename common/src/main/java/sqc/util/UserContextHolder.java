...
public class UserContextHolder {
    ...
    public String getName() {
         String name = Optional.ofNullable(threadLocal.get()).orElse(Maps.newHashMap()).get("name");
    ...
    public String getUserId() {return Optional.ofNullable(threadLocal.get()).orElse(Maps.newHashMap()).get("userId");}
